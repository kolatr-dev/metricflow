      ...
      FROM (
        ...
        FROM (
          ...
          FROM (
            ...
            WHERE subq_4.ds BETWEEN '2000-01-01' AND '2040-12-31'
          ) subq_3
          INNER JOIN (
            ...
            WHERE subq_1.metric_time__day BETWEEN '1999-12-30' AND '2040-12-31'
          ) subq_2
          ON
            (
              subq_2.metric_time__day <= subq_3.metric_time__day
            ) AND (
              subq_2.metric_time__day > subq_3.metric_time__day - INTERVAL 2 day
            )
        ) subq_5
      ) subq_6
      WHERE subq_6.metric_time__day BETWEEN '2000-01-01' AND '2040-12-31'
    ) subq_7

...
FROM (
  ...
  SELECT
    COALESCE(subq_12.metric_time__day, subq_25.metric_time__day, subq_31.metric_time__day) AS metric_time__day
            ...
            FROM (
              ...
              FROM (
                ...
                FROM (
                  ...
                  WHERE subq_1.metric_time__day BETWEEN '2000-01-01' AND '2040-12-31'
                ) subq_2
              ) subq_3
              LEFT OUTER JOIN (
                -- Pass Only Elements:
            ...
            FROM (
              ...
              FROM (
                ...
                FROM (
                  ...
                  WHERE subq_14.metric_time__day BETWEEN '2000-01-01' AND '2040-12-31'
                ) subq_15
              ) subq_16
              LEFT OUTER JOIN (
                -- Pass Only Elements:
  ...
  ON
    subq_12.metric_time__day = subq_25.metric_time__day
  FULL OUTER JOIN (
    -- Compute Metrics via Expressions
    SELECT
    ...
    FROM (
      ...
      SELECT
        ...
        , SUM(subq_29.booking_value) AS booking_value
      FROM (
        -- Pass Only Elements:
        ...
        FROM (
          ...
          WHERE subq_27.metric_time__day BETWEEN '2000-01-01' AND '2040-12-31'
        ) subq_28
      ) subq_29
      GROUP BY
        subq_29.metric_time__day
  ...
  ON
    COALESCE(subq_12.metric_time__day, subq_25.metric_time__day) = subq_31.metric_time__day
  GROUP BY
    COALESCE(subq_12.metric_time__day, subq_25.metric_time__day, subq_31.metric_time__day)
) subq_32

...
SELECT
  ...
  , subq_10.bookings AS family_bookings
FROM (
  -- Aggregate Measures
  SELECT
      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , subq_5.window_start__day AS listing__window_start__day
            , subq_5.window_end__day AS listing__window_end__day
            , subq_3.listing AS listing
            , subq_5.capacity AS listing__capacity
          ...
          ON
            (
              ...
              (
                subq_3.metric_time__day >= subq_5.window_start__day
              ) AND (
                (
                  subq_3.metric_time__day < subq_5.window_end__day
                ) OR (
                  subq_5.window_end__day IS NULL
                )
              )
            )
        ) subq_6

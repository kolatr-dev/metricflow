...
from metricflow.time.time_granularity_solver import TimeGranularitySolver
...
class MetricFlowQueryParser:
    ...
    def parse_and_validate_query(
        ...
        return MetricFlowQuerySpec(
            ...
            where_filter_linkable_spec_lookup=query_spec.where_filter_linkable_spec_lookup,
        )

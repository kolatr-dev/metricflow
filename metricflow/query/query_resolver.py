    ...
    def resolve_query(self, resolver_input_for_query: ResolverInputForQuery) -> MetricFlowQueryResolution:
        ...
        if InputToIssueSetMapping(tuple(input_to_issue_set_mapping_items)).has_errors:
            return MetricFlowQueryResolution(
                query_spec=None,
                resolution_dag=None,
                where_filter_linkable_spec_lookup=WhereFilterLinkableSpecLookup.empty_instance(),
        ...
        # Resolve where.
        where_filter_linkable_spec_lookup = self._resolve_where(
            resolution_dag=resolution_dag,
        )

        filter_input_issue_set = where_filter_linkable_spec_lookup.issue_set
        ...
        if InputToIssueSetMapping(tuple(input_to_issue_set_mapping_items)).has_errors:
            return MetricFlowQueryResolution(
                query_spec=None,
                resolution_dag=resolution_dag,
                where_filter_linkable_spec_lookup=where_filter_linkable_spec_lookup,
                input_to_issue_set=InputToIssueSetMapping(tuple(input_to_issue_set_mapping_items)),
            )
        ...
        # Run post-resolution validation rules.

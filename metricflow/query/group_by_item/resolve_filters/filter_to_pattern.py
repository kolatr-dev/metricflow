...
@dataclass(frozen=True)
class WhereFilterLinkableSpecLookup(Mergeable, PathPrefixable):
    ...
    @override
    def merge(self, other: WhereFilterLinkableSpecLookup) -> WhereFilterLinkableSpecLookup:
        return WhereFilterLinkableSpecLookup(
    ...
    @override
    @classmethod
    def empty_instance(cls) -> WhereFilterLinkableSpecLookup:
        return WhereFilterLinkableSpecLookup(
    ...
    @override
    def with_path_prefix(self, path_prefix_node: GroupByItemResolutionNode) -> WhereFilterLinkableSpecLookup:
        return WhereFilterLinkableSpecLookup(
...
class _ResolveCallParameterSetToSpecMappingSetVisitor(GroupByItemResolutionNodeVisitor[WhereFilterLinkableSpecLookup]):
    ...
    @override
    def visit_measure_node(self, node: MeasureGroupByItemResolutionNode) -> WhereFilterLinkableSpecLookup:
        with self._path_from_start_node_tracker.track_node_visit(node):
            return WhereFilterLinkableSpecLookup.empty_instance()

    @override
    def visit_metric_node(self, node: MetricGroupByItemResolutionNode) -> WhereFilterLinkableSpecLookup:
        with self._path_from_start_node_tracker.track_node_visit(node):
            results_to_merge: List[WhereFilterLinkableSpecLookup] = []
            ...
            return WhereFilterLinkableSpecLookup.merge_iterable(results_to_merge)

    @override
    def visit_query_node(self, node: QueryGroupByItemResolutionNode) -> WhereFilterLinkableSpecLookup:
    ...
    @override
    def visit_any_model_node(self, node: AnyModelGroupByItemResolutionNode) -> WhereFilterLinkableSpecLookup:
        with self._path_from_start_node_tracker.track_node_visit(node):
            return WhereFilterLinkableSpecLookup.empty_instance()
    ...
    def _resolve_mappings_for_where_filters_at_query_node(
        ...
        return WhereFilterLinkableSpecLookup.merge_iterable(results_to_merge).merge(
            WhereFilterLinkableSpecLookup(
                call_parameter_set_to_spec_mappings=(),
...
class WhereFilterLinkableSpecResolver:
    ...
    def resolve_lookup(self) -> WhereFilterLinkableSpecLookup:

...
class GroupByItemResolutionNodeVisitor(Generic[VisitorOutputT], ABC):
    @abstractmethod
    def visit_measure_node(self, node: MeasureGroupByItemResolutionNode) -> VisitorOutputT:  # noqa: D
        raise NotImplementedError

    @abstractmethod
    def visit_no_metrics_query_node(self, node: NoMetricsQueryGroupByItemResolutionNode) -> VisitorOutputT:  # noqa: D
        raise NotImplementedError
